...
public class SignSeekBar extends View {
    ...
    private void autoAdjustSection() {
        ...
        float x_=Float.parseFloat(bigDecimal.toString());
    ...
    private float formatFloat(float value) {
        ...
        //float aFloat = Float.parseFloat(bigDecimal.toString());
        return bigDecimal.setScale(8, BigDecimal.ROUND_HALF_UP).floatValue();
        //return aFloat;
