...
public class StatusBarUtil {
    ...
    private static final int FAKE_STATUS_BAR_VIEW_ID = com.raistone.wallet.sealwallet.R.id.statusbarutil_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = com.raistone.wallet.sealwallet.R.id.statusbarutil_translucent_view;
    ...
    private static void transparentStatusBar(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            activity.getWindow().setNavigationBarColor(Color.parseColor("#FE0000"));
            activity.getWindow().setStatusBarColor(Color.TRANSPARENT);
